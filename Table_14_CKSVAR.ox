/**	Sensitivity: Tests with alternative measures of long term rates and thus shorter sample periods
	Tests ZLB irrelevance hypothesis in Japan by testing exclusion of short rate (and no kink) in Y1 equations
...
main()
{
	...
	//	Setup the model	
		...
		if(ip)
			model.SetSelSampleByIndex(model.GetSelStart()+ip, model.GetSelEnd()) ;
