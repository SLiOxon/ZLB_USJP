...
main()
{
	...
	for(decl iJP = 0; iJP < 1; ++iJP){			// do US and JP
	...
	//	Setup the model	
		...
		model.Select(CKSVAR::Y1_VAR, {"INFL", 0, p, iJP ? "YGAP_BOJ" : "YGAP", 0, p, iJP? "LR9Y" : "LONGRATE", 0, p, "BAA10Y", 0, p});	  // Select Y1 (unconstrained) variables in the SVAR, for US, can also replace with EBP with BAA10Y
