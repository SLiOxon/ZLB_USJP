...
main()
{
	...
	decl p = iJP ? 2 : 4;						// lag length determined by the aic, if US and BAA10Y, then p = 3
	...
	//	Setup the model	
		...
		model.Select(CKSVAR::Y1_VAR, {"INFL", 0, p, iJP ? "YGAP_BOJ" : "YGAP", 0, p, iJP? "LR9Y" : "LONGRATE", 0, p, "EBP", 0, p});	  // Select Y1 (unconstrained) variables in the SVAR, for US, can also replace with EBP with BAA10Y
