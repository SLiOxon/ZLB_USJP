...
main()
{
	...
	decl fUseKSVARinit = idate ? FALSE : TRUE;	// if TRUE, estimate KSVAR first and use as initial values for estimation of CKSVAR. KSVAR initialisation achieves higher likelihood in date 1 but not in date 2
