...
main()
{
	...
	decl fusebootIRF = TRUE;                   // if TRUE, do bootstrapped IRFs
	decl fusestoredboot = FALSE;					// if you've already stored the bootstrap replications, set to TRUE to save time. If FALSE, the program will take more than one day to complete on 15 processors
