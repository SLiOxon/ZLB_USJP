...
options_ = [];
M_.fname = 'model_simple';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('model_simple.log');
M_.exo_names = 'u';
M_.exo_names_tex = 'u';
M_.exo_names_long = 'u';
M_.endo_names = 'q';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('model_simple_static');
erase_compiled_function('model_simple_dynamic');
...
save('model_simple_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('model_simple_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('model_simple_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('model_simple_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('model_simple_results.mat', 'estimation_info', '-append');
end
