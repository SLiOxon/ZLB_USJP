...
main()
{
	...
	//  Estimate unsrestricted model and record results
		decl vp;
		decl iYear_break = 2006 ;
				decl iquarter_break = iqt;
				decl iT_break = constant((iYear_break - iYear0)*4 + iquarter_break - iquarter0, 1, 1);
				println("Current break imposed: ", sprint(iYear_break, "Q", iquarter_break));
				ranseed(1234);
 				model.SetBreaks(/*vBreakPoints*/iT_break,/*aBreakParIndices*/{</*6;*/
